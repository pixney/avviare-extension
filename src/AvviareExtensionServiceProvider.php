...
class AvviareExtensionServiceProvider extends AddonServiceProvider
{
    ...
    protected $middleware = [
        //Pixney\AvviareExtension\Http\Middleware\ExampleMiddleware::class
    ];
     ...
     */
    protected $listeners = [
        //Pixney\AvviareExtension\Event\ExampleEvent::class => [
        //    Pixney\AvviareExtension\Listener\ExampleListener::class,
        //],
    ];
     ...
     */
    protected $aliases = [
        //'Example' => Pixney\AvviareExtension\Example::class
    ];
